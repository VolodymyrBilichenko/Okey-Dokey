...
import {MainAboutUsList} from "../../components/MainAboutUs/components/MainAboutUsList";
import {AboutUsStatistic} from "./components/AboutStatistic/AboutUsStatistic";
import {AboutUsContent} from "./components/AboutUsContent/AboutUsContent";
import {AboutUsContentReverse} from "./components/AboutUsContentReverse/AboutUsContentReverse";
    ...
    return (
        <div className='main'>
            ...
            <section className="about-us-hero container">
                <div className="about-us-hero__header visible-on-desktop">
                    <h1 className="about-us-hero__title section-title">
                        О нас
                    </h1>
                </div>
