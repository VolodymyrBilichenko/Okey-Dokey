        ...
        <li className="reviews__slider-mob--slide splide__slide reviews__item">
            ...
            <div className="reviews__item--info">
                ...
                <div className="reviews__item--text">
                    <p>
                        Спасибо большое создателям такой прекрастной школы, я на уроки летела пулей, так как было очень
                        интересно и познавательно.Всем советую обучить именно в этой школе.
                    </p>
                </div>
            </div>
        </li>
